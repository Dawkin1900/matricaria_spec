...
- `/data` - Папка, содержащая исходные данные, обработанные данные,
  а также тренировочные изображения для подачи на вход модели
...
- `/report` - Папка, содержащая информацию о метриках после обучения, history модели,
  словарь с закодированными метками классов
